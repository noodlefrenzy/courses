...
class Vgg16():
    ...
    def fit(self, batches, val_batches, nb_epoch=1):
        """
            ...
            See Keras documentation: https://keras.io/models/model/
        """
        self.model.fit_generator(batches, steps_per_epoch=ceil(batches.samples/batches.batch_size),
                nb_epoch=nb_epoch, validation_steps=ceil(val_batches.samples/val_batches.batch_size))
    ...
    def test(self, path, batch_size=8):
        ...
        return test_batches, self.model.predict_generator(test_batches, ceil(test_batches.samples/test_batches.batch_size))
